...
We'll use a potential-based argument to track the total time across $$k$$ operations.
...
Let's count more carefully using credits:
...
Total: 4 edge traversals = $$O(k + h) = O(3 + 3) = O(6)$$ ✓
