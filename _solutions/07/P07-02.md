...
### A. All elements equal: $$\Theta(n^2)$$ running time
...
### B. Three-way partition procedure
...
### C. Modified quicksort with three-way partitioning
...
### D. Adjusted analysis without distinct elements
