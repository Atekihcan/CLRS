...
The same principle can be extended: if you do not know $$p$$ but want to simulate a coin with probability $$q$$, you can still use this technique as a building block!
{% endcapture %}
