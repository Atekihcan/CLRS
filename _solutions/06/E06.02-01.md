...
![Max-Heapify Step #1]({{ '/assets/img/06/6.2-1_tree_step_1.png' | prepend: site.baseurl }} "Max-heapify step 1")
...
![Max-Heapify Step #2]({{ '/assets/img/06/6.2-1_tree_step_2.png' | prepend: site.baseurl }} "Max-heapify step 2")
...
![Max-Heapify Step #3]({{ '/assets/img/06/6.2-1_tree_step_3.png' | prepend: site.baseurl }} "Max-heapify step 3")
