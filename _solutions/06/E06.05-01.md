...
![Heap-Extract-Max Initial]({{ '/assets/img/06/6.5-1_step_1.png' | prepend: site.baseurl }} "Heap-Extract-Max initial state")
...
![Heap-Extract-Max Step 2]({{ '/assets/img/06/6.5-1_step_2.png' | prepend: site.baseurl }} "After moving last element to root")
...
![Heap-Extract-Max Step 3]({{ '/assets/img/06/6.5-1_step_3.png' | prepend: site.baseurl }} "After first swap with 13")
...
![Heap-Extract-Max Step 4]({{ '/assets/img/06/6.5-1_step_4.png' | prepend: site.baseurl }} "After second swap with 12")
...
![Heap-Extract-Max Final]({{ '/assets/img/06/6.5-1_step_5.png' | prepend: site.baseurl }} "Final state after third swap with 6")
