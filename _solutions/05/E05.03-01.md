...
1 $$n = A.\textit{length}$$
2 swap $$A$$[1] with $$A$$[$$\textsc{Random}$$(1, $$n$$)]
3 **for** $$i = 2$$ **to** $$n$$
4     swap $$A$$[$$i$$] with $$A$$[$$\textsc{Random}$$($$i$$, $$n$$)]
{% endcapture %}
