...
{% capture note %}
*In 2015*, in the first iteration of the post, I was using Intel i5 3570K (4 cores @3.4 GHz), $$n_0 = 17$$.

*In 2021*, I was using AMD Ryzen 1600 (6 cores @3.2GHz) along with many other system upgrades like better RAM/cache etc. (also <span class="rainbow">RGB</span>), $$n_0 = 28$$.

*In 2025*, I am using Macbook with M4 Pro (8 cores 4.05 GHz + 4 cores 2.75 GHz) again with better RAM etc, $$n_0 = 34$$.
