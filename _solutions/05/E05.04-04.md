...
When this expected value is at least 1, we can expect that there is likely to be a day with at least 3 people.
...
We can verify this numerically. The exact probability that at least one day has 3 or more people can be computed, though it is complex. For $$k = 88$$:
