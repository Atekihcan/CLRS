...
Here's another recursive version that passes the parent node as a parameter, avoiding the need to return and reassign:
...
3. Many compilers don't optimize tail recursion for the second recursive case
