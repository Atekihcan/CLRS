...
This makes intuitive sense: it is not uncommon to get lucky and have the best candidate come first, but it is astronomically unlikely to get candidates in perfect increasing order.
{% endcapture %}
