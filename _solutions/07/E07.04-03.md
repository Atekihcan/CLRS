...
Here is a neat visualization in [Desmos](https://www.desmos.com/calculator/rmpktwypgq){:target="_blank"}. Head over there to play with the variables.

![Recurrence Relation]({{ '/assets/img/07/7.4-3.gif' | prepend: site.baseurl }} "Recurrence relatio visualization")
