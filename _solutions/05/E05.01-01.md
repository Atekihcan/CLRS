...
Intuitively this is trivial: _We can only determine the best candidate only if we can compare all the candidates to establish an order._

But to prove this, we need to demonstrate that being able to compare any two candidates implies the three properties of a **total order**: comparability, transitivity, and antisymmetry.
