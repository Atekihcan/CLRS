...
The idea is to create a **composite key** for sorting that combines the random priority with the original index. When priorities are equal, we break ties using a secondary randomized criterion.
